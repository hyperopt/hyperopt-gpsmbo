...
setuptools.setup(
    ...
    packages = packages,
    scripts = scripts,
    url = 'http://github.com:hyperopt/hp_gpsmbo/',
    author = 'James Bergstra',
    author_email = '',
    description = 'Gaussian Process Regression with Theano',
    long_description = '',
    classifiers = [
    ...
    license = 'LGPL3',
    keywords = 'Theano machine learning',
    package_data = package_data,
    include_package_data = True,
    #install_requires = ['theano', 'scipy', 'numpy'],
)
